...
When you're done, with ~git stash apply~, you're back where you were.  It applies
the top stash by default.  But if that doesn't work, for whatever reason, you
can use any of Git's other branch merging tools to put things back they way you
want them.
