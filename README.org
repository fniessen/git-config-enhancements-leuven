...
#+begin_src text :tangle ~/.git_commit_msg.txt
######## 50 characters ###########################
...
# :hammer: Update: input_your_summary
# :recycle: Refactor: input_your_summary
# :computer: Tool: input_your_summary

######## 72 characters #################################################
# Why is this change necessary? (Bug fix, feature, improvements?)
-
...
#+begin_src conf
    username = "XXX"
    repo-slug = "!f() { git remote show origin -n | grep 'Fetch URL:' | sed -E 's#^.*/(.*)$#\\1#' | sed 's#.git$##'; }; f"
#+end_src
