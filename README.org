...
#+begin_src conf
    ...
    delete-merged-branches = "!git branch --no-color --merged | grep -v '\\*' | \
                               grep -v master | \
...
Generate a version of your [[https://keepachangelog.com/][CHANGELOG.md]]:

#+begin_src conf
    # Detailed list of changes.
    # repo-user
    # repo-name
    changelog-github = !sh -c 'git log $1...$2 --pretty=format:\"* %s [view commit](http://github.com/$3/$4/commit/%H)\"' -
...
#+begin_src shell :tangle no
git changelog-github first_tag last_tag github_username github_repo
#+end_src
