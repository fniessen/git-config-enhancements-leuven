...
#+begin_src conf
    ...
    # Less readable, less convenient and less user-friendly.
#+end_src
            ...
            if [ \"$branch\" != \"$current_branch\" ]; then \
                ...
                if [ $(git rev-list --count origin/$branch..$branch) -gt 0 ]; then \
                    if git pull --ff-only; then \
                        ...
                        echo \"Failed to update $branch. Please resolve any conflicts manually.\"; \
                    fi; \
                else \
                    echo \"No new commits to fetch for $branch\"; \
                fi; \
                echo; \
            fi; \
        done; \
