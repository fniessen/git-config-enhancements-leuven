...
You can easily host websites directly in your cloud repository management
system.  And open HTML files directly from the file browser.
...
Create a =README= file into your repository.
...
#+begin_src conf :tangle no
    ...
    delete-all-tags = "!f() { for t in $(git tag); do
                                  git tag -d $t
                                  git push origin :$t
                              done;
                            }; f"
