...
##? Usage: git-is-ancestor [options] REV1 REV2
##?
##? Check if one commit is an ancestor of another.
##?
##? Arguments:
...
#+begin_src conf
    show-tag-by-date = log --tags --simplify-by-decoration --pretty="format:%ai %d"

    show-tags = show-ref --tags
