...
See https://github.com/so-fancy/diff-so-fancy/issues/364#issuecomment-652598381.
#+end_tip
...
#+begin_src conf
    tag-contains = git tag -l --contains HEAD
#+end_src
...
You can easily host websites directly in your repository management platform.
And open HTML files directly from the file browser.
