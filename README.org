...
If a feature branch is behind the main branch, you can sync (merge) the branch
with the main branch, to catch your branch up to all the latest changes on the
main branch.
