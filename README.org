...
#+begin_src conf
    repo-owner = "!f() { git remote show origin -n \
                             | grep 'Fetch URL:' \
                             | sed -E 's#^.*[/:](.*)/.*$#\\1#' \
                             | sed 's#.git$##'; }; f"
#+end_src
...
#+begin_src conf
    browse-commits = "!f() { URL=$(git config --get remote.origin.url); \
...
#+begin_src conf
    delete-remote-merged-branches = "XXX"
#+end_src
...
#+begin_src conf
    ...
    ahead-of-master = !git log --oneline origin/master..HEAD
#+end_src
...
#+begin_src conf
    browse-issues = "!f() { URL=$(git config --get remote.origin.url); \
...
#+begin_src conf
    browse-wiki = "!f() { URL=$(git config --get remote.origin.url); \
