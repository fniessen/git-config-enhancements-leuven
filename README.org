...
To delete all untracked files (and directories), you can run ~git purge~. It won't
remove staged changes, like modified files still uncommitted.
...
*WARNING -- BE CAREFUL WITH THIS!* It is helpful to run a dry-run with ~git
purge-dry-run~ first, to see what it will delete, and be sure it's what you want.
