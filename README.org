...
#+begin_src conf
    releases = log --no-merges --all --simplify-by-decoration --oneline --graph
...
#+begin_src conf
    today = !git log --since=midnight --author=\"${1-$(git config --get user.name)}\" --no-merges --all --pretty='%C(green)%ad%C(auto) - %s' --date=format:'%Y-%m-%d %a %H:%M'

    yesterday = !git log --since='1 day ago midnight' --until=midnight --author=\"${1-$(git config --get user.name)}\" --no-merges --all --pretty='%C(green)%ad%C(auto) - %s' --date=format:'%Y-%m-%d %a %H:%M'

    this-week = !git log --since='1 week ago' --author=\"${1-$(git config --get user.name)}\" --no-merges --all --pretty='%C(green)%ad%C(auto) - %s' --date=format:'%Y-%m-%d %a %H:%M'
#+end_src
