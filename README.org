...
#+Time-stamp: <2013-03-08 Fri 15:14>
#+DESCRIPTION:
#+KEYWORDS:
#+LANGUAGE:  en_US
...
[alias]
	...
	lga = log --decorate --all --pretty=format:'%C(yellow)%h%Creset %C(bold cyan)%d%Creset %s %Cgreen<%an> %C(bold blue)(%cd)%Creset' --abbrev-commit --date=short --graph
	y = diff "@{yesterday}"
	w = whatchanged
	who = shortlog -s --
	dc = diff --cached
