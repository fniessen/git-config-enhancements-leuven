...
#+begin_warning
Git's --author option is case-sensitive.
#+end_warning

*************** TODO Search for commits by an author in a case-insensitive way
By filtering the results with ~grep~ to achieve case-insensitive matching?
*************** END
